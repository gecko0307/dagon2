...
## Shaders
Shader modules are usually loaded from GLSL source files:
...
`ShaderModule` compiles the source file and caches SPIR-V module to disk for reuse. It is recompiled only if the source file is newer than SPIR-V file.
