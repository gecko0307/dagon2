...
Dagon includes native DDS importer and exporter with no external dependencies, while KTX/KTX2 depends on [libktx](https://github.com/khronosgroup/ktx-software).
