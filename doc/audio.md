...
Dagon provides an audio playback extension, `dagon2:audio`. It is based on a [fork](https://github.com/gecko0307/soloud) of SoLoud, a lightweight sound engine for games written in C++.
...
- 2D and 3D sound
- Many audio backends, including SDL, MiniAudio, PortAudio, OpenAL, WASAPI and others
- Many supported audio formats, including WAV, MP3, FLAC, OGG/Vorbis. Tracker formats via OpenMPT
- `SoundComponent` for entities for automatic spatial positioning
- `PlaylistPlayer` for managing background music.
