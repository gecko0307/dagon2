Dagon Engine 2
--------------
Work-in-progress SDL3 port of [Dagon Engine](https://github.com/gecko0307/dagon). Feature-rich, easy to use, extensible desktop game development framework for [D language](https://dlang.org/) based on Vulkan 1.0 and SDL3. Works on Windows and Linux.
